...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function xa(e,t,n){let r=new Float32Array(sa),i=new q(0,1,0);return new ri({name:`SphericalGaussianBlur`,defines:{n:sa,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:wa(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Sa(){return new ri({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:wa(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ca(){return new ri({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:wa(),fragmentShader:`
	...
	`}var Ta=class extends Ot{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ur(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=Uo(i,i.VERTEX_SHADER,y),S=Uo(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1){if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=Yo(i,x,`vertex`),n=Yo(i,S,`fragment`);H(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
`;function mc({color:e=`#c755f7`,backgroundColor:t=`#05010a`,speed:n=.5,curvature:i=.25,scanlineStrength:a=.25,scanlineFrequency:o=200,waveAmplitude:s=.3,waveFrequency:c=2.5,bloom:l=1.5,bloomRadius:u=1,noise:d=.1,vignette:f=0,brightness:p=1.25,pixelation:m=1,rgbShift:h=.015,mouseReact:g=!0,mouseStrength:_=.5,dpr:v=1,fps:y=30,paused:b=!1,className:x,style:S}){let C=(0,r.useRef)(null),w=(0,r.useRef)(null),T=(0,r.useRef)(null),E=(0,r.useRef)(null),D=(0,r.useRef)(b),O=(0,r.useRef)(new K(0,0)),k=(0,r.useRef)(new K(0,0)),A=(0,r.useRef)(!0),j=(0,r.useRef)(y),ee=(0,r.useRef)(0);return(0,r.useEffect)(()=>{D.current=b},[b]),(0,r.useEffect)(()=>{j.current=Math.max(1,y)},[y]),(0,r.useEffect)(()=>{let e=C.current;if(!e)return;let t=new mn,n=new ki(-1,1,1,-1,0,1),r=new Jr(2,2),i=new ri({vertexShader:fc,fragmentShader:pc,uniforms:{uResolution:{value:new K(1,1)},uTime:{value:0},uSpeed:{value:.5},uColor:{value:new X(`#c755f7`)},uBackgroundColor:{value:new X(`#05010a`)},uCurvature:{value:.25},uScanlineStrength:{value:.25},uScanlineFrequency:{value:200},uWaveAmplitude:{value:.3},uWaveFrequency:{value:2.5},uBloom:{value:1.5},uBloomRadius:{value:1},uNoise:{value:.1},uVignette:{value:0},uBrightness:{value:1.25},uPixelation:{value:1},uRgbShift:{value:.015},uPointer:{value:new K(0,0)},uMouseStrength:{value:.5},uMouseReact:{value:1}}});w.current=i;let a=new jr(r,i);t.add(a);let o;try{o=new uc({antialias:!1,alpha:!1,powerPreference:`low-power`})}catch{e.style.background=`radial-gradient(ellipse at 50% 40%, #150826 0%, #05010a 70%)`,i.dispose(),r.dispose(),w.current=null;return}T.current=o,o.outputColorSpace=ze,o.setPixelRatio(Math.min(window.devicePixelRatio||1,1)),o.domElement.style.width=`100%`,o.domElement.style.height=`100%`,o.domElement.style.display=`block`,e.appendChild(o.domElement);let s=()=>{let t=Math.max(e.clientWidth,1),n=Math.max(e.clientHeight,1);o.setSize(t,n,!1),i.uniforms.uResolution.value.set(o.domElement.width,o.domElement.height)},c=new ResizeObserver(s);c.observe(e),s();let l=new Gi,u=new IntersectionObserver(([e])=>{A.current=e.isIntersecting});u.observe(e);let d=e=>{if(E.current=requestAnimationFrame(d),!A.current||document.hidden)return;let r=1e3/j.current;if(e-ee.current<r)return;ee.current=e-(e-ee.current)%r;let a=Math.min(l.getDelta(),.1);D.current||(i.uniforms.uTime.value+=a*i.uniforms.uSpeed.value),k.current.lerp(O.current,.08),i.uniforms.uPointer.value.copy(k.current),o.render(t,n)};d(0);let f=t=>{let n=e.getBoundingClientRect();O.current.set((t.clientX-n.left)/Math.max(n.width,1)*2-1,-((t.clientY-n.top)/Math.max(n.height,1)*2-1))},p=()=>O.current.set(0,0);return e.addEventListener(`pointermove`,f,{passive:!0}),e.addEventListener(`pointerleave`,p),()=>{E.current!==null&&cancelAnimationFrame(E.current),c.disconnect(),u.disconnect(),e.removeEventListener(`pointermove`,f),e.removeEventListener(`pointerleave`,p),r.dispose(),i.dispose(),o.dispose(),o.domElement.remove(),w.current=null,T.current=null}},[]),(0,r.useEffect)(()=>{let r=w.current,y=T.current;if(!r||!y)return;let b=r.uniforms;b.uColor.value.set(e),b.uBackgroundColor.value.set(t),b.uSpeed.value=n,b.uCurvature.value=i,b.uScanlineStrength.value=a,b.uScanlineFrequency.value=o,b.uWaveAmplitude.value=s,b.uWaveFrequency.value=c,b.uBloom.value=l,b.uBloomRadius.value=u,b.uNoise.value=d,b.uVignette.value=f,b.uBrightness.value=p,b.uPixelation.value=m,b.uRgbShift.value=h,b.uMouseReact.value=+!!g,b.uMouseStrength.value=_,y.setPixelRatio(Math.min(window.devicePixelRatio||1,v));let x=C.current;x&&(y.setSize(Math.max(x.clientWidth,1),Math.max(x.clientHeight,1),!1),b.uResolution.value.set(y.domElement.width,y.domElement.height))},[t,l,u,p,e,i,v,g,_,d,m,h,o,a,n,y,f,s,c]),(0,dc.jsx)(`div`,{ref:C,className:`relative h-full w-full overflow-hidden ${x||``}`,style:S})}export{mc as default};